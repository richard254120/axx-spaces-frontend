...
const styles = {
  container: { maxWidth: "1200px", margin: "0 auto", padding: "20px", background: "linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #f5576c 75%, #4facfe 100%)", minHeight: "100vh", fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont" },
  ...
  filterInput: { padding: "10px 14px", border: "1px solid rgba(255, 255, 255, 0.3)", borderRadius: "6px", background: "rgba(255, 255, 255, 0.9)", color: "#1e293b", fontSize: "0.95rem", minWidth: "150px", boxShadow: "0 4px 15px rgba(0, 0, 0, 0.1)" },
  filterSelect: { padding: "10px 14px", border: "1px solid rgba(255, 255, 255, 0.3)", borderRadius: "6px", background: "rgba(255, 255, 255, 0.9)", color: "#1e293b", fontSize: "0.95rem", minWidth: "140px", boxShadow: "0 4px 15px rgba(0, 0, 0, 0.1)" },
  priceRange: { display: "flex", gap: "8px", alignItems: "center" },
  priceSeparator: { color: "#ffffff", fontWeight: 600 },
  resultsRow: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px", flexWrap: "wrap", gap: "10px" },
  resultsCount: { color: "#ffffff", fontSize: "0.95rem", fontWeight: 600 },
  ...
  card: { background: "rgba(255, 255, 255, 0.95)", border: "1px solid rgba(255, 255, 255, 0.3)", borderRadius: "12px", overflow: "hidden", transition: "all 0.3s ease", display: "flex", flexDirection: "column", height: "100%", boxShadow: "0 8px 32px rgba(0, 0, 0, 0.1)" },
  ...
  title: { color: "#1e293b", fontSize: "1.2rem", margin: "0 0 8px 0", wordBreak: "break-word", fontWeight: 700 },
  location: { color: "#64748b", margin: "0 0 12px 0", fontSize: "0.9rem" },
  specs: { display: "flex", gap: "10px", margin: "12px 0", flexWrap: "wrap" },
  spec: { color: "#475569", fontSize: "0.85rem", background: "rgba(102, 126, 234, 0.1)", padding: "4px 8px", borderRadius: "4px" },
  price: { color: "#667eea", fontSize: "1.1rem", fontWeight: 700, margin: "8px 0" },
  description: { color: "#475569", fontSize: "0.85rem", margin: "8px 0", lineHeight: "1.4" },
